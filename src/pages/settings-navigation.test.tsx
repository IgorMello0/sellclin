...
vi.mock('@/pages/Profile',()=>({default:function ProfileMock(){const navigate=useNavigate();return <button onClick={()=>navigate('/settings?tab=security')}>Atalho de senha</button>}}));
